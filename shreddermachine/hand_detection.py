...
if __name__ == '__main__':
    ...
    # To get the frame by using open CV
    ...
    try:
        while True:
            # We are reading the frame
            frame = vs.read()
            frame = np.array(frame) # convert frame into numpy array as we going to send it to our model
            ...
            # Drawing the blue line and Red line
